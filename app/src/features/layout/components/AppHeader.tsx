 ...
 * Scope: Public-page header. Renders logo, treasury, GitHub, session-aware account slot, theme toggle. Does not handle routing or analytics.
    ...
    <header className="border-border border-b bg-background py-3">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          {/* Right side: GitHub + Account + Theme */}
