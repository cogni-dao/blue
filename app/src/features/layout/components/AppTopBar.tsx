 ...
 * Purpose: Top bar for authenticated app pages with sidebar trigger, treasury, GitHub, and account slot.
 * Scope: Renders top bar within SidebarInset. Does not handle authentication or sidebar state.
 * Invariants: SidebarTrigger requires SidebarProvider ancestor; GitHub visible lg+ only; account chrome is shared with public headers.
 * Side-effects: none
    ...
    <header className="flex h-16 w-full shrink-0 items-center justify-between border-b px-3 md:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <a
          ...
          aria-label="cogni/blue on GitHub"
